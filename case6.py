...
import config
from unlearn.ferrari import unlearn
...
if __name__ == "__main__":
    ...
    if not args.is_onboarding:
        ...
        # Load the final global model from case0
        ...
        for round in range(num_rounds, end_round):
            ...
            # save global param
            save_param(args, param=global_param, case=6, round=round)
        ...
        global_param = torch.load(
            f"./results/models/case6/case6_{args.dataset}_C{args.num_clients}_BS{args.batch_size}_R{args.num_rounds}_UR{args.num_unlearn_rounds}_PR{args.num_post_training_rounds}_E{args.local_epochs}_LR{args.lr}_round{start_round-1}.pt"
        )

        res = load_results(
            f"./results/case6_{args.dataset}_C{args.num_clients}_BS{args.batch_size}_R{args.num_rounds}_UR{args.num_unlearn_rounds}_PR{args.num_post_training_rounds}_E{args.local_epochs}_LR{args.lr}.pkl"
        )
